    ...
    <tr>
      <td align="center" style="padding:0;">
        <table role="presentation" style="width:602px;border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;text-align:left;">
          ...
          <tr>
            <td style="padding:30px;background:#1747BD;">
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;font-size:9px;font-family:Arial,sans-serif;">
                <tr>
                  <td style="padding:0;width:100%;" align="left">
                    <p style="margin:0;font-size:12px;line-height:16px;font-family:Arial,sans-serif;color:#ffffff;text-align:justify;">
                      &reg;Dux System Cloud © 2023. Este es un correo de carácter informativo, favor de no responder. Si tienes alguna duda, consulta nuestra sección de Ayuda o comunícate al *88888888 para obtener mayor información.
                    </p>
                  </td>
