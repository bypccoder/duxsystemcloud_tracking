                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" id="txtNombre" name="name"
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body" style="max-height: 385px; overflow-y: auto;">
                                <div class="chat-container">
                                    @foreach ($user->history->sortByDesc('created_at') as $change)
                                        @if ($change->type_row == 'update')
                                            <div class="chat-message d-flex mb-2">
                                                ...
                                                <div class="message-content p-3 border rounded change-message">
                                                    <p class="message-time text-muted small mb-2">{{ $change->created_at }}
                                                    </p>
